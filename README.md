...
**page_brute.py** is a digital forensic tool purposed to analyze and categorize individual paged memory frames from the Windows Page Files by appying YARA-based signatures to fix-sized blocks of pagefile.sys. 
